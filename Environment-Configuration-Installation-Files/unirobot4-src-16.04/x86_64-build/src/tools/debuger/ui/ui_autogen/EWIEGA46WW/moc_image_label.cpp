/****************************************************************************
** Meta object code from reading C++ file 'image_label.hpp'
**
...
#include "../../../../../../../src/tools/debuger/ui/image_label.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'image_label.hpp' doesn't include <QObject>."
...
void ImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->shot((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ImageLabel::*_t)(QRect );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageLabel::shot)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ImageLabel::shot(QRect _t1)
{
